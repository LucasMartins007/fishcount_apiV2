...
import com.fishcount.api.repository.pattern.IRepository;
import com.fishcount.api.repository.pattern.IRepositoryOperations;
...
public class RepositoryImpl<T extends AbstractEntity<?>, I>
        implements IRepositoryOperations<T>, IRepository<T, I>, Repository<T, I> {
